...
#     prompt = f"Convert the following user input into an SQL query: '{user_input}'"
...
#     model = genai.GenerativeModel('gemini-pro')
#     prompt = f"Summarize the following database results in a user-friendly way: {results}"
#     response = model.generate_content(prompt)
#     return response.text
